        ...
        <div className="min-h-screen w-full flex flex-col items-center justify-start pt-18">
            ...
            <form onSubmit={handleLogin} className="flex flex-col items-center gap-4 w-full"
                ...
                <div className="flex flex-col gap-2 w-full">
                    <label className="font-semibold" htmlFor="identifier">{t("login.usernameOrEmail")}</label>
                    <input
                    ...
                    <button
                        className="w-full mt-3 px-4 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition enabled:cursor-pointer disabled:bg-gray-300"
                        type="submit"
